...
public class Entity {
    ...
    public Entity currentToque;
    public boolean toque = false;
    ...
    protected final int type_key = 7;
    protected final int type_toque = 8;
    ...
    public void update() {
        ...
        if(knockBack == true) {
            ...
            // Increase knockBackCounter to have more knock back
